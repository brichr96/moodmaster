...
public final class DBHandler_Impl extends DBHandler {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `moods` (`moodID` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `mood` INTEGER NOT NULL, `date` TEXT)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'e32aec6193b275696373a673ede81cdb')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsMoods.put("date", new TableInfo.Column("date", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "e32aec6193b275696373a673ede81cdb", "7136f243e567842ab00105a1a2941872");
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(MoodDao.class, MoodDao_DBHandler_Impl.getRequiredConverters());
  ...
  public MoodDao moodDao() {
    if (_moodDao != null) {
      ...
      synchronized(this) {
        if(_moodDao == null) {
          _moodDao = new MoodDao_DBHandler_Impl(this);
        }
        return _moodDao;
      }
    }
